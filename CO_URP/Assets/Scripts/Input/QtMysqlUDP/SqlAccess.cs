...
public class SqlAccess
{
    ...
    public void addTable_t_03_002(T_table t_03_002)
    {
        string sql = "INSERT INTO t_03_002 VALUES (@C001, @C002, @C003, @C004, @C005, @C006, @C007, @C008, @C009, @C010, @C011, @C012, @C013, @C014, @C015, @C016, @C017, @C018, @C019, @C020)";
        try
        {
            using (MySqlCommand cmd = new MySqlCommand(sql, dbConnection))
            {
    ...
    public int queryEvaTimes(string patientId, string evaId)
    {
        ...
        {
            Debug.Log("SearchTable_t_03_002()--query table t_03_002 Exception:" + ee.Message);
            Debug.Log("addTable_t_03_002()--insert table t_03_002 Exception: sql：" + sql);
